...
import { Mail, Lock, Eye, EyeOff, Zap, Github, Loader2 } from 'lucide-react'
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-8">
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="mt-8 text-center">
            <p className="text-muted-foreground">Join thousands of teams transforming how they work with AI.</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Sign in to your Orbit AI workspace</p>
          </div>
